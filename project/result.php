...
<body>
    ...
    <div class="sec">
    <div class="result"><h3>Result of the class coordinator election [dept-MCA]</h3></div>
    <div class="border_bottom"></div>
    <div class="sec1">
    <div class="r_sec">
        <h1 style="color:blue">Fish =<?php echo $n1; ?></h1>
        <h1 style="color:orange">Glass = <?php echo $n2; ?></h1>
        <h1 style="color:red">Bulb = <?php echo $n3; ?></h1>
        <h1 style="color:green">NOTA = <?php echo $n4; ?></h1>
        <h1 style="color:black">Total = <?php echo $n5; ?></h1>
    </div>
    ...
    <script>
        ...
        function draw_my_chart(){
            ...
            data.addRows([['Fish',<?php echo $n1;?>],
                        ['Bulb', <?php echo $n3;?>],
                        ['Glass', <?php echo $n2;?>],
                        ['NOTA', <?php echo $n4;?>]
                        ]);
                // above row adds the JavaScript two dimensional array data into required chart format
            var options = {title:'Result:Pie Chart',is3D:'true',legend:'left',backgroundColor: 'transparent',width:700,height:450,};
